...
const prosjektLenker = {
  ...
  bilagsassistent: BILAGSASSISTENT_PROSJEKT_PATH,
...
export function getMocResultaterPunkter(lang: Lang): MocResultatPunkt[] {
  ...
  if (lang === "en") {
    return [
      ...
      `Built ${lenke(prosjektLenker.readinessScan, "AI Readiness Scan")}: access-controlled mapping tool with structured assessment of AI maturity, priorities and admin insight`,
  ...
  return [
    ...
    `Bygget ${lenke(prosjektLenker.readinessScan, "AI Readiness Scan")}: tilgangsstyrt kartleggingsverktøy med strukturert vurdering av AI-modenhet, prioriteringer og administrativ innsikt`,
