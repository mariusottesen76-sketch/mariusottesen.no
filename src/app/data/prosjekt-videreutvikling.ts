...
const tekster: Record<string, Record<Lang, string>> = {
  ...
  "row-solutions-2026": {
    no: "Row Solutions er bygget som eget kommersielt initiativ med ferdigstilt nettside for rowsolutions.no — ennå ikke offentlig publisert. Arbeidsmetoden kan overføres til andre SMB-er, rådgivningsmiljøer og kunnskapsbedrifter som må koble posisjonering, tjenester, innhold og kommersiell digital tilstedeværelse.",
    en: "Row Solutions is built as its own commercial initiative with a completed website for rowsolutions.no — not yet publicly published. The working method can be transferred to other SMBs, advisory environments and knowledge businesses that must connect positioning, services, content and commercial digital presence.",
  },
  "skoyenasen-tannklinikk-2026": {
    ...
    en: "The case is built for patient journey and booking in dental care, but can be adapted for other clinics, service businesses and customer-journey-oriented organisations. Further potential includes recall, digital follow-up, multilingual front-end, smart intake and booking flows for other clinics, healthcare services and service businesses with extensive customer dialogue and booking.",
  },
