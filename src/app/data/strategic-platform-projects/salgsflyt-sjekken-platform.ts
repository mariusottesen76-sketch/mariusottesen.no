...
import { SMB_SALGSFLYT_MATURITY_LABEL } from "../../lib/smb-salgsflyt-brand";
...
export const salgsflytSjekkenPlatform: StrategicPlatformProject = {
  ...
  detail: {
    statusBadge: SMB_SALGSFLYT_MATURITY_LABEL,
    hero: {
      verdiforslag: {
