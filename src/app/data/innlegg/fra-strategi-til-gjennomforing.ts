...
export const fraStrategiTilGjennomforing: FaginnleggInnlegg = {
  id: "fra-strategi-til-gjennomforing-2026-09",
  tittel: {
    no: "Fra strategi til gjennomføring",
    en: "From strategy to execution",
  },
  undertittel: {
    no: "Hvordan lukker vi gapet mellom beslutning og ny arbeidshverdag?",
    en: "How do we close the gap between decision and a new everyday work reality?",
  },
  teaser: {
    no: "Strategi skaper ikke verdi fordi ledergruppen er enig. Den må oversettes til prioriteringer, ansvar, arbeidsflyt, kompetanse, lederrytme og ny atferd – og til slutt resultater.",
    en: "Strategy does not create value because the leadership team agrees. It must be translated into priorities, accountability, workflow, competence, leadership rhythm and new behaviour – and ultimately results.",
  },
  metaDescription: {
    no: "Strategiimplementering handler om mer enn beslutninger og planer. Slik kobles prioriteringer, ansvar, arbeidsflyt, kompetanse og lederrytme til ny atferd og resultater.",
    en: "Strategy implementation is about more than decisions and plans. How priorities, accountability, workflow, competence and leadership rhythm connect to new behaviour and results.",
  },
  dato: "2026-09-02",
  visningsDato: "02.09.26",
  kategori: "Endring og gjennomføring",
  bildeUrl: "/images/strategi-til-gjennomføring.png",
  bildeModalBred: true,
  bildeKortFokus: "54% 38%",
  bildeAlt: {
    no: "Marius Ottesen i ledergruppedialog om strategi, prioriteringer og gjennomføring.",
...
Utfordringen ligger i alt som skal skje <strong>mellom beslutningen og den nye arbeidshverdagen</strong>.

For meg er det her strategiimplementering og transformasjon virkelig begynner.

<h2>Fra intensjon til handling</h2>
...
<strong>En strategi er også en intensjon før den er blitt til en arbeidsmåte.</strong>

<h2>Virksomhetens eget intensjons–atferdsgap</h2>
...
<h2>Strategien hopper ikke fra PowerPoint til resultater</h2>
...
<h2>Det er ikke alltid motstand når mennesker fortsetter som før</h2>
...
Strategien begynner å bevege seg fra <strong>hva vi ønsker</strong> til <strong>hvordan vi skal arbeide</strong>.

<h2>Jeg har sett gjennomføringen stoppe etter at alle var enige</h2>
...
<h2>Hva må ledergruppen avklare?</h2>
...
<h2>Strategien lever i lederrytmen</h2>
...
Transformasjon bør etter hvert slutte å være noe organisasjonen <strong>gjør ved siden av arbeidet</strong>.

Den må bli en del av <strong>måten arbeidet ledes på</strong>.

<h2>Vi må måle om ny praksis etableres</h2>
...
<h2>Ny atferd er heller ikke sluttmålet</h2>
...
Derfor bør siste ledd i gjennomføringsmodellen alltid være <strong>resultater og gevinst</strong>.
...
<strong>Transformasjon skjer først når mandag morgen ser annerledes ut enn før.</strong>

<h2>Kilder</h2>

<strong>Ottesen, Marius (2013).</strong> <em>«The road to hell is paved with good intentions». Manglende samsvar mellom intensjoner og atferd – kan ‘intensjons-atferds gapet’ minimeres?</em> Prosjektoppgave, PR-ledelse og strategisk kommunikasjon, Handelshøyskolen BI. Oppgaven bygger blant annet på Theory of Planned Behavior og forskning på implementeringsintensjoner.

<strong>Gollwitzer, Peter M. & Paschal Sheeran (2006).</strong> <em>Implementation Intentions and Goal Achievement: A Meta-analysis of Effects and Processes</em>. Advances in Experimental Social Psychology, 38, 69–119. DOI: 10.1016/S0065-2601(06)38002-1

<a href="https://doi.org/10.1016/S0065-2601(06)38002-1" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">https://doi.org/10.1016/S0065-2601(06)38002-1</a>.

<strong>McKinsey & Company (2025).</strong> <em>A new operating model for a new world.</em>

<a href="https://www.mckinsey.com/capabilities/people-and-organizational-performance/our-insights/a-new-operating-model-for-a-new-world" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">https://www.mckinsey.com/capabilities/people-and-organizational-performance/our-insights/a-new-operating-model-for-a-new-world</a>

<strong>McKinsey & Company (2026).</strong> <em>Collective action, collective success: A CEO’s role in transformations.</em>

<a href="https://www.mckinsey.com/capabilities/transformation/our-insights/collective-action-collective-success-a-ceos-role-in-transformations" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">https://www.mckinsey.com/capabilities/transformation/our-insights/collective-action-collective-success-a-ceos-role-in-transformations</a>

<strong>McKinsey & Company (2023).</strong> <em>How to implement transformations for long-term impact</em>.

<a href="https://www.mckinsey.com/capabilities/implementation/our-insights/how-to-implement-transformations-for-long-term-impact" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">https://www.mckinsey.com/capabilities/implementation/our-insights/how-to-implement-transformations-for-long-term-impact</a>`,
  },
};
