...
💥 <a href="/salgsflyt-sjekken" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">SMB Salgsflyt-sjekken</a>, <a href="/psc" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">The Predictive Sales Coach</a>, <a href="/flowsignal" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">FlowSignal</a>, <a href="/event-planner" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">Event Planner</a> og <a href="/bilagsassistent" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">Bilagsassistent</a> adresserer behov innen salg, kundedialog, samspill, teamsamarbeid, arrangementsplanlegging, administrativ dokumentasjon, læring og prestasjonsutvikling.
...
💥 <a href="/salgsflyt-sjekken" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">SMB Sales Flow Check</a>, <a href="/psc" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">The Predictive Sales Coach</a>, <a href="/flowsignal" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">FlowSignal</a>, <a href="/event-planner" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">Event Planner</a> and <a href="/bilagsassistent" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">Receipt Assistant</a> address needs in sales, customer dialogue, interaction, team collaboration, event planning, administrative documentation, learning and performance development.
