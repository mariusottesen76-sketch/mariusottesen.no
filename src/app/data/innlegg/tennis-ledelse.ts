...
<strong>Link til hjemmesiden:</strong> www.mariusottesen.no`
    ...
    },
    {
      ...
      kategori: "Kommersiell Ledelse",
      link: "https://www.linkedin.com/in/mariusottesen/recent-activity/all/",
      innhold: `Hyggelig gest av Visindi som kjørte en god og profesjonell rekrutteringsprosess da jeg ble headhuntet til Franzefoss Gjenvinning AS! :-)`
    },
    {
      id: "obf-klar-2025-01",
      ...
      kategori: "Kommersiell Ledelse",
      link: "https://www.linkedin.com/in/mariusottesen/recent-activity/all/",
      innhold: `🚀 Klar for to dager med inspirasjon på Oslo Business Forum 2025 – The Big Shift!

Jeg ser frem til et tettpakket program med sterke foredragsholdere, nye perspektiver og mye faglig påfyll. Like viktig er møtene med både gamle og nye bekjentskaper – alltid spennende å dele erfaringer og bygge relasjoner på tvers av bransjer.
...
To inspirerende og lærerike dager er over – fylt med sterke foredrag, viktige perspektiver og energi rundt strategi, ledelse, teknologi og fremtidens muligheter. I tillegg markerte årets konferanse 10-årsjubileet til Oslo Business Forum – en milepæl som viser hvilken betydning arenaen har fått for ledere.
...
En påminnelse om hva langsiktig innsats, hardt arbeid, utholdenhet og styring kan skape – enten det handler om byggverk, prestasjon, kompetanse eller mennesker.`
    },
    {
      ...
      kategori: "Kommersiell Ledelse",
      link: "https://www.linkedin.com/in/mariusottesen/recent-activity/all/",
      innhold: `Etter 2 år som Nasjonal Salgssjef i Franzefoss Gjenvinning har jeg valgt å gå videre

Bakgrunnen er ulike strategiske syn på veien videre – og et bevisst valg om å investere tid i videre utvikling og kompetanse før endringene tvinger seg frem, blant annet innen AI.
