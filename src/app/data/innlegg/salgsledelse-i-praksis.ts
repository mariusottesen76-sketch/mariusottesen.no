...
export const salgsledelseIPraksis: FaginnleggInnlegg = {
  id: "salgsledelse-i-praksis-2026-08",
  tittel: {
...
<strong>Tallene bør starte samtalen, ikke avslutte den.</strong>
...
<strong>Når mer aktivitet ikke er svaret</strong>
...
<strong>KPI-ene viser hvor vi bør se</strong>
...
<strong>Medarbeideren skal gradvis bli bedre til å prioritere, vurdere og handle uten at lederen må være involvert i alle beslutninger.</strong>

Det skaper sterkere selgere, større eierskap og en mer skalerbar salgsorganisasjon.

<strong>KPI-er og CRM er salgsledelsens sensorer</strong>
...
<strong>KPI-er og CRM er salgsledelsens sensorer. Coaching og prioritering er selve ledelsesarbeidet.</strong>
...
<strong>Hva bør en salgsleder egentlig bruke tiden sin på?</strong>
...
Cespedes, Frank V. (2021). <em>Avoid a One-Size-Fits-All Approach to Sales Coaching</em>. Harvard Business Review, 16. desember 2021.

<a href="https://hbr.org/2021/12/avoid-a-one-size-fits-all-approach-to-sales-coaching" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">https://hbr.org/2021/12/avoid-a-one-size-fits-all-approach-to-sales-coaching</a>
...
<strong>The numbers should start the conversation, not end it.</strong>
...
<strong>When more activity is not the answer</strong>
...
<strong>KPIs show where we should look</strong>
...
<strong>The employee should gradually become better at prioritising, assessing and acting without the leader needing to be involved in every decision.</strong>

That creates stronger salespeople, greater ownership and a more scalable sales organisation.

<strong>KPIs and CRM are the sensors of sales leadership</strong>
...
<strong>KPIs and CRM are the sensors of sales leadership. Coaching and prioritisation are the leadership work itself.</strong>
...
<strong>What should a sales leader actually spend time on?</strong>
...
Cespedes, Frank V. (2021). <em>Avoid a One-Size-Fits-All Approach to Sales Coaching</em>. Harvard Business Review, 16 December 2021.
