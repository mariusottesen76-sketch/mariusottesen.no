...
Da endres også spørsmålet fra: <strong>«Hva må jeg registrere?»</strong> til: <strong>«Hva trenger jeg og andre å vite for at vi skal følge opp kunden bedre?»</strong>
...
Målet bør derfor ikke være identisk bruk. Målet bør være <strong>tilstrekkelig felles praksis til at relevant kundeinformasjon kan forstås, deles og brukes på tvers</strong>.
...
God CRM-praksis handler derfor ikke om å registrere mest mulig. Den handler om å registrere det virksomheten <strong>trenger for å arbeide bedre</strong>.
...
<strong>Det som legges inn, kommer tilbake som verdi.</strong> Og da blir det også lettere å bygge tillit til systemet.
...
Lederne setter forventningene. Lederne prioriterer arbeidsformen. Lederne avgjør <strong>om informasjonen brukes i praksis</strong>. Og lederne sender et tydelig signal gjennom sin egen adferd.
...
For meg er det kjernen i CRM som lederoppgave. Ikke et system virksomheten skal få medarbeiderne til å bruke. Men en felles arbeids- og informasjonsstruktur som gjør <strong>medarbeideren bedre rustet, virksomheten bedre koordinert og kunden bedre fulgt opp.</strong>
...
<a href="https://doi.org/10.1108/JBIM-08-2021-0380" class="text-indigo-300 underline underline-offset-2 decoration-indigo-500/70 hover:text-indigo-200 transition-colors">https://doi.org/10.1108/JBIM-08-2021-0380</a>. Studien av 126 virksomheter viser blant annet den sentrale rollen brukerinvolvering spiller i håndteringen av CRM-implementeringens teknologiske og organisatoriske kompleksitet.`,
    en: `A company can have a good CRM system and still have a poor customer picture. Dashboards can be in place. The fields can be defined. Leadership can have clear expectations for registration.
...
Then the question also shifts from: <strong>"What do I have to register?"</strong> to: <strong>"What do I and others need to know so that we can follow up the customer better?"</strong>
...
The goal should therefore not be identical use. The goal should be <strong>sufficient shared practice so that relevant customer information can be understood, shared, and used across functions</strong>.
...
Good CRM practice is therefore not about registering as much as possible. It is about registering what the company <strong>needs in order to work better</strong>.
...
<strong>What is entered comes back as value.</strong> And then it also becomes easier to build trust in the system.
...
Leaders set the expectations. Leaders prioritize the way of working. Leaders decide <strong>whether the information is actually used in practice</strong>. And leaders send a clear signal through their own behavior.
...
For me, that is the core of CRM as a leadership task. Not a system the company must get employees to use. But a shared work and information structure that makes <strong>the employee better equipped, the company better coordinated, and the customer better followed up.</strong>
