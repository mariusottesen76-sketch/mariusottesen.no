  ...
  bilderUnderHovedbilde: [
    {
      ...
      alt: {
        no: "QR-kode – lenke til tilgangsstyrt The Predictive Sales Coach (PSCv2.0)",
...
For arbeidsgivere viser prosjektet hvordan AI kan brukes til ferdighetsutvikling, onboarding, salgsledelse og kompetansekartlegging. Prosjektet viser hvordan AI kan støtte trening, refleksjon og prestasjon før viktige kundemøter.
...
${prosjektTilgangStandard.no} ${prosjektKontaktLenke("no", "Ta gjerne kontakt")} ${prosjektKontaktDialogTekst.no}. ${pscAppLink} åpner den tilgangsstyrte løsningen.`,
...
For employers, the project shows how AI can be used for skills development, onboarding, sales leadership and competence mapping. The project shows how AI can support training, reflection and performance before important customer meetings.
...
${prosjektTilgangStandard.en} ${prosjektKontaktLenke("en", "Feel free to get in touch")} ${prosjektKontaktDialogTekst.en}. ${pscAppLink} opens the access-controlled solution.`,
  },
};
