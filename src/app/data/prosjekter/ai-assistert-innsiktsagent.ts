...
/** Kort metadata for /prosjekter — full dokumentasjon på /agentisk-arbeidsflyt */
export const aiAssistertInnsiktsagent: ProsjektType = {
  ...
  teaser: {
    no: "Konsept og demonstrert agentisk arbeidsflyt — dokumentert på egen prosjektside.",
    en: "Concept and demonstrated agentic workflow — documented on a dedicated project page.",
  },
