...
/** Kort metadata for /prosjekter — full dokumentasjon på /ai-arkitektur-beslutningsstotte */
export const aiArkitekturBeslutningsstotte: ProsjektType = {
  ...
  bildeUrl: "/images/ai-arkitektur-beslutningsstotte-hjemmeside.png?v=20260718",
  bildeRamme: "natural",
  dato: "2026-01-30",
