...
export const skoyenasenTannklinikk: ProsjektType = {
  ...
  tittel: "Skøyenåsen Tannklinikk",
  teaser:
    "Virksomhetsnært AI-case for pasientreise, smart intake, veiledet booking og mer systematisk oppfølging.",
  bildeUrl: "/images/skoyenasen-tk.gif",
  dato: "2026-03-26",
  visningsDato: "26.03.2026",
  bildeHint: {
  ...
  innhold: `Skøyenåsen Tannklinikk er et virksomhetsnært utviklingscase med fokus på hvordan AI og digitale løsninger kan forbedre pasientreisen før og etter behandling. Arbeidet tar utgangspunkt i konkrete behov knyttet til behovsavklaring, riktigere booking, tydeligere informasjon, bedre oppfølging og en mer moderne digital pasientflyt.
