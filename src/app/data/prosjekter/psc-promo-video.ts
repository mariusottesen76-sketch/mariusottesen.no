...
export const pscPromoVideo: ProsjektType = {
  ...
  teaser: {
    no: "PSCv6, DISC og strukturert salgstrening, formidlet gjennom min første AI-genererte reklamefilm. Prosjektet viser både hvordan AI kan brukes i salgstrening, og hvordan generativ AI kan brukes til visuell konseptformidling og kommersiell posisjonering.",
    en: "PSCv6, DISC and structured sales training, conveyed through my first AI-generated commercial. The project shows both how AI can be used in sales training and how generative AI can be used for visual concept communication and commercial positioning.",
  },
...
Dette er en promovideo for ${pscLink} (PSCv6) og ${mocLink}. Videoen viser hvordan AI, DISC-inspirert kundepsykologi og strukturert salgstrening kan gjøre møteforberedelser mer presise, relevante og målbare.
...
Det er utviklet en AI-generert promovideo som viser hvordan PSCv6 kan brukes til møteforberedelse, DISC-inspirert kundetilpasning, strukturert salgstrening og bedre gjennomføring i B2B-salg.
...
Filmen viser hvordan en selger og salgssjef kan bruke PSCv6 til å forberede et realistisk kundemøtescenario, forstå kundens personprofil, trene på ulike salgsfaser og gå inn i møtet med større trygghet.
...
Ferdig produsert promovideo og kommunikasjonsartefakt. Videoen støtter posisjoneringen av PSCv6 og Marius Ottesen Consulting.
...
Se videoen for å forstå hvordan PSCv6 kan brukes i praktisk salgstrening, eller ${prosjektKontaktLenke("no")} for en gjennomgang av løsningen.`,
    en: `<strong>What the project is</strong>

This is a promotional video for ${pscLink} (PSCv6) and ${mocLinkEn}. The video shows how AI, DISC-inspired customer psychology and structured sales training can make meeting preparation more precise, relevant and measurable.
...
An AI-generated promotional video was developed showing how PSCv6 can be used for meeting preparation, DISC-inspired customer adaptation, structured sales training and better execution in B2B sales.
...
The film shows how a salesperson and sales manager can use PSCv6 to prepare for a realistic customer-meeting scenario, understand the customer's profile, practise different sales phases and enter the meeting with greater confidence.
...
Completed promotional video and communication artefact. The video supports the positioning of PSCv6 and Marius Ottesen Consulting.
...
Watch the video to understand how PSCv6 can be used in practical sales training, or ${prosjektKontaktLenke("en")} for a walkthrough of the solution.`,
  },
};
