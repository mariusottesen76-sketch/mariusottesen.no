    ...
    jobs: [
      {
        ...
        results:
          'Developed several concrete AI projects and pilot environments, including <a href="/psc">The Predictive Sales Coach</a> and <a href="/flowsignal">FlowSignal</a>, plus advisory concepts for value leaks, CRM, customer dialogue, sales development and team execution. Strengthened positioning as commercial leader and AI strategist through <a href="/faginnlegg">articles</a>, projects, <a href="/consulting">consulting</a> and a clearer <a href="/">digital platform</a>.',
      },
      {
