...
const data = {
  no: {
    ...
    kompetanse: [
      ...
      "Resultatansvar, personalansvar og lønnsom vekst",
      "Endringsledelse og organisasjonsutvikling",
      "KPI, målstyring, CRM og salgsoppfølging",
      "Teamutvikling, coaching og styrkebasert ledelse",
  ...
  en: {
    ...
    kompetanse: [
      ...
      "Results accountability, people management and profitable growth",
      "Change leadership and organisational development",
      "KPIs, target management, CRM and sales follow-up",
      "Team development, coaching and strengths-based leadership",
