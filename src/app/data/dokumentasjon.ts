...
const data = {
  no: {
    ...
    mobilityLabel: "Praktisk",
    mobilityPractical:
      "Komfortabel med jobbrelatert reise ca. 1–2 dager per uke, nasjonalt og/eller internasjonalt når rollen tilsier det.",
    ...
    aiText: [
      "Jeg har videreutviklet min kommersielle og strategiske lederkompetanse innen AI (kunstig intelligens/KI) gjennom masterkurset <em class=\"italic\">Generative AI for Business</em> ved BI, kombinert med egne AI-prosjekter innen transformasjonsstyring, operasjonell planlegning, salgstrening, samhandling, innsiktsarbeid, beslutningsstøtte og agentiske arbeidsflyter. Dette inkluderer executive konseptplattformen <em class=\"italic\">AI Transformation & Value Realization</em>, <em class=\"italic\">Control Tower</em> og apper som <em class=\"italic\">Event Planner</em> og <em class=\"italic\">Bilagsassistent</em>, samt kommersielt initiativet <em class=\"italic\">Row Solutions</em> med ferdigstilt nettside for rowsolutions.no (ennå ikke offentlig publisert). Jeg har også tatt initiativ til <em class=\"italic\">AI Value Lab Oslo</em>, et tverrfaglig lærings- og utviklingsinitiativ med fokus på praktisk testing, ansvarlig bruk av AI og reell verdiskaping gjennom virksomhetsnære case.",
    ],
  ...
  en: {
    ...
    mobilityLabel: "Practical",
    mobilityPractical:
      "Comfortable with business travel approximately 1–2 days per week, nationally and/or internationally when the role requires it.",
    ...
    aiText: [
      "I have further developed my commercial and strategic leadership competence in AI (artificial intelligence) through the <em class=\"italic\">Generative AI for Business</em> master's programme at BI, combined with my own AI projects in transformation governance, operational planning, sales training, collaboration, insight work, decision support and agentic workflows. This includes the executive concept platform <em class=\"italic\">AI Transformation & Value Realization</em>, <em class=\"italic\">Control Tower</em> and apps such as <em class=\"italic\">Event Planner</em> and <em class=\"italic\">Receipt Assistant</em>, as well as the commercial initiative <em class=\"italic\">Row Solutions</em> with a completed website for rowsolutions.no (not yet publicly published). I have also initiated <em class=\"italic\">AI Value Lab Oslo</em>, a cross-disciplinary learning and development initiative focused on practical testing, responsible use of AI and real value creation through business-near cases.",
    ],
