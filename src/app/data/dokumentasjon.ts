...
const data = {
  no: {
    ...
    aiText: [
      "Jeg har videreutviklet min kommersielle og strategiske lederkompetanse innen AI (kunstig intelligens/KI) gjennom masterkurset <em class=\"italic\">Generative AI for Business</em> ved BI, kombinert med egne AI-prosjekter innen transformasjonsstyring, operasjonell planlegning, salgstrening, samhandling, innsiktsarbeid, beslutningsstøtte og agentiske arbeidsflyter. Dette inkluderer executive konseptplattformen <em class=\"italic\">AI Transformation & Value Realization</em>, <em class=\"italic\">Control Tower</em> og apper som <em class=\"italic\">Event Planner</em>, samt kommersielt initiativet <em class=\"italic\">Row Solutions</em> med ferdigstilt nettside for rowsolutions.no (ennå ikke offentlig publisert). Jeg har også tatt initiativ til <em class=\"italic\">AI Value Lab Oslo</em>, et tverrfaglig lærings- og utviklingsinitiativ med fokus på praktisk testing, ansvarlig bruk av AI og reell verdiskaping gjennom virksomhetsnære case.",
    ],
