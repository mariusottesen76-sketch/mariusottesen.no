...
export const detailHeroAudit: DetailHeroAuditEntry[] = [
  ...
  },
  {
    ...
    heroImage: "/images/skoyenasen-tannklinikk-hjemmeside.png?v=20260717f",
    aspectNote: "Vertikalt 1:3 på detaljside — object-contain",
    objectPosition: "center",
    fit: "contain",
    needsNewDetailHero: true,
    notes: "Oversikt (/prosjekter): vertikal forgrunn + landscape bak (hjemmeside-bak). Detalj: vertikal hjemmeside.",
  },
  {
  ...
  },
  {
    ...
    heroImage: "/images/innsikt-handling.png",
    aspectNote: "Horisontalt bilde — produser agentisk-arbeidsflyt-hero.png i 3:1",
    objectPosition: "center",
    fit: "contain",
    needsNewDetailHero: true,
    notes: "Anbefalt fil: agentisk-arbeidsflyt-hero.png (1800×600 px, 3:1).",
  },
  {
    route: "/ai-innsikts-og-innholdsmotor",
    projectId: "ai-assistert-innsikts-og-innholdsagent-2026",
    heroImage: "/images/ai-assistert-arbeidsflyt.jfif",
    aspectNote: "Horisontalt bilde — produser ai-innsikts-og-innholdsmotor-hero.png i 3:1",
    objectPosition: "center",
    fit: "contain",
    needsNewDetailHero: true,
    notes: "Anbefalt fil: ai-innsikts-og-innholdsmotor-hero.png (1800×600 px, 3:1).",
  },
  {
    route: "/ai-arkitektur-beslutningsstotte",
    projectId: "ai-arkitektur-beslutningsstotte-2026",
    heroImage: "/images/ai-arkitektur-beslutningsstotte-dashboard.jpg?v=20260717d",
    aspectNote: "Norsk dashboard (2:1) — object-cover i 3:1",
    objectPosition: "center",
    fit: "cover",
    needsNewDetailHero: false,
    notes: "Fullt dashboard-bilde — samme asset som oversikt.",
  },
  {
    route: "/ai-value-lab-oslo",
    projectId: "ai-value-lab-oslo-2026",
    heroImage: "/images/ai-value-lab-banner.png",
    aspectNote: "Banner-foto — produser ai-value-lab-oslo-hero.png i 3:1",
    objectPosition: "center",
    fit: "contain",
    needsNewDetailHero: true,
    notes: "Midlertidig ai-value-lab-banner.png. Anbefalt fil: ai-value-lab-oslo-hero.png (1800×600 px, 3:1).",
  },
];
