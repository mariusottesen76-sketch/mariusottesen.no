...
export const detailHeroAudit: DetailHeroAuditEntry[] = [
  ...
  },
  {
    ...
    heroImage: "/images/ai-beslutningsstotte-dashboard.png?v=20260519",
    aspectNote: "Dashboard-screenshot — produser ai-arkitektur-beslutningsstotte-hero.png i 3:1",
    objectPosition: "center top",
    fit: "contain",
    needsNewDetailHero: true,
    notes: "Anbefalt fil: ai-arkitektur-beslutningsstotte-hero.png (1800×600 px, 3:1).",
  },
  {
