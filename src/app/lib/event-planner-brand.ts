 ...
 */
export const EVENT_PLANNER_IMAGE_VERSION = "20260808c";
 ...
 *
 * Innhold: illustrative demo-captures — mobil hero (oversikt) og landscape med venstremeny + arrangementshero.
 */
