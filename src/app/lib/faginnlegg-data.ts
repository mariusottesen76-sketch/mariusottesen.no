...
export function getAlleFaginnlegg(): FaginnleggInnlegg[] {
  return ([...tennisLedelse, ...aiGovernance, obf2026Dag2, obf2026Dag1, obf2026HumanEdge, deBesteKommersielleGrepene, fraDataTilBeslutning, salgsledelseIPraksis, crmMerEnnEtSystemprosjekt, fraStrategiTilGjennomforing] as FaginnleggInnlegg[]).sort(sortByDateDesc);
}
